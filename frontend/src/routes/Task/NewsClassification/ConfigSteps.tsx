...
interface ConfigStepsProps {
  ...
  onSubmit: (params: {
    ...
    taskName?: string
    taskParams?: TNewsClassificationTaskParams
  }) => Promise<string | null>
}
...
const DEFAULT_CATEGORIES: TTextClassificationCategory[] = [
  {
    category: '政治',
    description: '政府工作报告、党建、理论学习、公务员培训、国家政策等',
  },
  {
    category: '经济',
    description: '刺激消费、产业升级、企业服务、经济发展、经济规划等',
  },
  {
    category: '文化',
    description: '传统节日、剧团、美食、历史文学作品、非遗、文化活动等',
  },
...
export default function ConfigSteps({ onSubmit }: ConfigStepsProps) {
  ...
  const [classificationMode, setClassificationMode] =
    useState<TNewsClassificationMode>('SINGLE_CLASS')
    ...
    <div>
      ...
      <div className="mb-6 rounded-sm border border-gray-200 bg-white p-4">
        ...
        <Radio.Group
          ...
          onChange={(e) =>
            setClassificationMode(e.target.value as TNewsClassificationMode)
          }
        >
      ...
      <div className="mb-6 rounded-sm border border-gray-200 bg-white p-4">
        <div className="mb-3 flex items-center justify-between">
          ...
          <Button
            ...
            onClick={() =>
              createAndDownloadTemplateFile('新闻主题分类_数据模板.xlsx')
            }
          >
            下载示例文本
          </Button>
