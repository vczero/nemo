...
import { Steps, Input, Button, Upload, Checkbox, App } from 'antd'
import {
  UploadOutlined,
  FileTextOutlined,
  DownloadOutlined,
...
interface ConfigStepsProps {
  config: TDocSimTaskConfigResponse | null
  configLoading: boolean
  onSubmit: (params: {
    inputFiles?: TInputFile[]
    taskName?: string
    taskParams?: TDocSimTaskParams
  }) => Promise<string | null>
}
          ...
          <div className="mb-6 rounded-sm border border-gray-200 bg-white p-4">
            ...
            <div className="my-2 flex flex-wrap gap-3">
              ...
              <Button
                ...
                type="default"
                onClick={() =>
                  createAndDownloadTemplateFile('文本相似度_数据模板.xlsx')
                }
              >
                下载样例数据
              </Button>
          ...
          <div className="mb-6 rounded-sm border border-gray-200 bg-white p-4">
            ...
            <div className="my-2 flex flex-wrap gap-3">
              ...
              <Button
                ...
                type="default"
                onClick={() =>
                  createAndDownloadTemplateFile('文本相似度_停用词模板.xlsx', [
                    ['id', 'text'],
                    [1, '停用词 1'],
                    [2, '停用词 2'],
                  ])
